public class ConicalMug extends Mug {
    ...
    public int getTopArea() {
        return (int) (getWidth() / 2.0 * getWidth() / 2.0 * Math.PI);
    }
     ...
     * public void print() {
     * System.out.
     * printf("%s mug (%dmm x %dmm -> %dmm), holding %.3fl and up to %d marshmallows.%n"
     * ,
     * getName(), getHeight(), getWidth(), base, getVolume(),
     * getMarshmallowLimit());
     * }
     */
    ...
    public String toString() {
        return String.format("%s mug (%dmm x %dmm -> %dmm), holding %.3fl and up to %d marshmallows.",
